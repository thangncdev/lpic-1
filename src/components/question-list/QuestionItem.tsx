    ...
    <div className="border border-gray-200 rounded-xl overflow-hidden bg-white">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            {question.type === 'fill_blank' ? (
              <span className="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">Điền</span>
            ) : isMulti ? (
              <span className="text-xs bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full">
                Chọn {question.correctAnswers.length}
              </span>
            ) : (
              <span className="text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full">Một đáp án</span>
            )}
          </div>
      ...
      {open && (
        <div className="px-5 pb-5 border-t border-gray-100 pt-4">
          {question.type === 'fill_blank' ? (
            <div>
              <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Đáp án</div>
            ...
            <div>
              <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Các lựa chọn</div>
